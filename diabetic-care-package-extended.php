                        ...
                        <div class="row package-inner-box align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="pg-content">
                                    <h3>Diabetic Care Package -Extended</h3>
                                    <div class="star">
                                        <img src="assets/img/stras.png" alt="">
                                    </div>
                                    <p>A  health check designed for persons of chronic diabetes.</p>
                                    <div class="rate">
                                        <p class="org">MRP: 2800/-</p>
                                        <p class="package-price">Package Price - 1999/- <span>(Savings 801/-)</span></p> 
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card my-2">
                                                ...
                                                <div id="collapseOne" class="collapse" data-parent="#dianova-accordion">
                                                    <div class="card-body">
                                                        <p>blood sugar ( fasting )</p>
                                                        <p>blood sugar (  after food )</p>
                                                        <p> HbA1c</p>
                                                        <p> insulin </p>
                                                        <p> c-peptide</p>
                                                    </div>
