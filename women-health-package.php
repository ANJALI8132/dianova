                        ...
                        <div class="row package-inner-box align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="pg-content">
                                    <h3>Comprehensive Health Check Package For Women</h3>
                                    <div class="star">
                                        <img src="assets/img/stras.png" alt="">
                                    </div>
                                    <p>Complete health check for women.</p>
                                    <div class="rate">
                                        <p class="org">MRP: 3,705/-</p>
                                        <p class="package-price">Package Price - 2,700/- <span>(Savings 1,005/-)</span></p> 
                                    </div>
