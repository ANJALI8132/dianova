                ...
                <div class="row">
                    <div class="col-12 text-left">
                        <div class="bread-head">
                            <h1 class="small-head">Men Health Package - Extended</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="row package-inner-box align-items-center">
                            <div class="col-lg-6 p-0">
                                <div class="img">
                                    <img src="assets/img/package-inner/3.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="pg-content">
                                    <h3>Comprehensive Health Check Package For Men -  Extended</h3>
                                    <div class="star">
                                        <img src="assets/img/stras.png" alt="">
                                    </div>
                                    <p>Designed to know your complete health staus - men.</p>
                                    <div class="rate">
                                        <p class="org">MRP: 7055/-</p>
                                        <p class="package-price">Package Price - 4900/- <span>(Savings 2155/-)</span></p> 
                                    </div>
