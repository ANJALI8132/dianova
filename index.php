    ...
    <div class="main">
                        ...
                        <div class="row align-items-center h-785">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="welcome-intro">
                                    ...
                                    <div class="intro-btn2">
                                        <a href="health-package.php">View All Health Packages</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- <section class="services-area section">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <div class="service-head tab-content" id="myTabContent">

                            <div class="tab-pane fade show active" id="firstone" role="tabpanel" aria-labelledby="firstone-tab">
                                <h2>Our Services</h2>
        ...
        <!-- ***** Health Package Area Start ***** -->
        <section class="health-package section ptb_100">
        ...
        <!-- ***** Sample Collection Area Start ***** -->
        <section class="sample-area">
            <div class="sample-left-bg">
                <img src="assets/img/bg/sample-collection.png"">
            </div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="sample-inner">
                            <div class="head">
                                <h1>Home Sample <br>Collection</h1>
                            </div>
                            <div class="text">
                                <p>We make it easy for critically ill patients, offering them the convenience of collecting test samples at home, which are later sent to collection centres in order to be sent to our labs for detailed diagnosis.</p>
                            </div>
        ...
        <section class="reporting-area">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6 p-0" style="background-color: #f0f4fb;">
                        <div class="online-report">
                            <div class="head">
                                <h1><span>Online</span> Reporting</h1>
                            </div>
                            <div class="inner">
                                <div class="icon">
                    ...
                    <div class="col-lg-6 p-0" style="background-color: #fff3e5;">
                        <div class="database-report">
                            <div class="head">
                                <h1><span>Database of</span> Medical Reports</h1>
                            </div>
                            <div class="inner">
                                <div class="icon">
